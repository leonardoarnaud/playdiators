...
class DuelItemWidget extends StatelessWidget {
  final String gameName;
  final String platform;
  final int createdAt;
  final String player1Image;
  final String player1Nick;
  final String player2Image;
  final String player2Nick;
  final DuelItemType status;
...
enum DuelItemType { VICTORY, DEFEAT, TIE, PROGRESS }